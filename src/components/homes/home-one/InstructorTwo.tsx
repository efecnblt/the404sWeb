                  ...
                  <div className="col-xl-6">
                     <div className="instructor__item-two tg-svg" ref={svgIconRef}>
                        ...
                        <div className="instructor__content-two">
                           ...
                           <p>Share your expertise, inspire learners, and grow your teaching career with us. Join a community of passionate educators and create impactful learning experiences worldwide.</p>
                  ...
                  <div className="col-xl-6">
                     <div className="instructor__item-two tg-svg" ref={svgIconRef2}>
                        ...
                        <div className="instructor__content-two">
                           ...
                           <p>Unlock your potential and expand your knowledge with courses designed for you. Join a vibrant learning community and take the first step toward achieving your goals.</p>
                           <div className="tg-button-wrap">
                              <Link to="/registration" className="btn arrow-btn">Apply Now <BtnArrow /></Link>
                           </div>
                        </div>
                     </div>
                  </div>
