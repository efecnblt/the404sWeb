               ...
               <div className="col-lg-6">
                  <div className="faq__img-wrap tg-svg" ref={svgIconRef}>
                     ...
                     <div className="faq__img">
                        <img src="/assets/img/others/faq_img_02.png" alt="img" />
               ...
               <div className="col-lg-6">
                  <div className="faq__content">
                     <div className="section__title pb-10">
                        ...
                        <h2 className="title">Start Learning From<br /> Our Instructors</h2>
                     </div>
                     <p>Gain knowledge and skills with personalized guidance from our dedicated instructors. Your journey to success begins here.</p>
