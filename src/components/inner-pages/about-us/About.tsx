               ...
               <div className="row align-items-center justify-content-center">
                  <div className="col-lg-6 col-md-9">
                     <div className="about__images-three tg-svg" ref={svgIconRef}>
                        <img src="/assets/img/others/gtu.jpg" alt="img" />
                  ...
                  <div className="col-lg-6">
                     <div className="about__content-three">
                        <div className="section__title mb-10">
                           ...
                           <h2 className="title">
                              Empowering learners to achieve their goals with
                        ...
                        <p className="desc">Inspiring growth and success through flexible, accessible education.</p>
                        <ul className="about__info-list list-wrap">
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Learn from Inspiring Educators</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Access Learning Anytime, Anywhere</p>
                           </li>
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right"></i>
                              <p className="content">Tailored Course Plans for Your Needs</p>
                           </li>
                        </ul>
                        <div className="tg-button-wrap">
                           <Link to="/registration" className="btn arrow-btn">Start Free Trial <BtnArrow /></Link>
                        </div>
                     </div>
                  </div>
               </div>
