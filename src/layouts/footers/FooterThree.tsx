                  ...
                  <div className="col-xl-2 col-lg-4 col-md-6">
                     <div className="footer__widget">
                        <div className="logo mb-35">
                           <Link to="">
                              <div
                                  ...
                                  style={{fontFamily: "'Leckerli One', cursive", fontSize: 24, color: "white"}}
                              >
                                 404 Academy
                              </div>
                           </Link>
                        ...
                        <div className="footer__content footer__content-two">
                           <p>Cumhuriyet, 2254. Sk. No:2, 41400 Gebze/Kocaeli</p>
                           <ul className="list-wrap">
                              <li><Link to="tel:0123456789">+90 (0262) 605 10 00</Link></li>
                              <li className="email"><Link to="mailto:info@gmail.com">efecanbolat34@gmail.com</Link></li>
                           </ul>
                        </div>
                     </div>
                  </div>
                     ...
                     <div className="footer__widget">
                        ...
                        <div className="footer__link">
                           <ul className="list-wrap">
                              ...
                              <li><Link to="/registration">Become Student</Link></li>
                           </ul>
                        </div>
                     </div>
                  </div>
                     ...
                     <div className="footer__widget">
                        ...
                        <div className="footer__link">
                           <ul className="list-wrap">
                              ...
                              <li><Link to="/contact">Become Teacher</Link></li>
                  ...
                  <div className="col-xl-4 col-lg-6 col-md-6">
                     <div className="footer__widget">
                        ...
                        <div className="footer__newsletter">
                           <p>Get the latest 404 news delivered to you inbox</p>
               ...
               <div className="row align-items-center">
                  <div className="col-md-7">
                     <div className="copy-right-text">
                        <p>© 2024-2024. All rights reserved.</p>
                     </div>
                  </div>
