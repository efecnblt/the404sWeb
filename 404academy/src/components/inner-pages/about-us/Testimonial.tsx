...
const testi_data: DataType[] = [
   {
      ...
      avatar_name: "Mehmet Yıldız",
      desc: "“Kurslar çok iyi yapılandırılmış ve eğitmenler gerçekten alanında uzman. Kesinlikle tavsiye ederim!”",
   },
   {
      id: 2,
      avatar_thumb: "/assets/img/others/testi_author02.png",
      avatar_name: "Suna Çelik",
      desc: "“Pratik projeler öğrendiklerimi hemen uygulamama yardımcı oldu. Bu platform tam bir devrim.”",
   },
   {
      id: 3,
      avatar_thumb: "/assets/img/others/testi_author03.png",
      avatar_name: "Furkan Yıldız",
      desc: "“Ders planları çok kolay takip ediliyor ve içerikler oldukça etkileyici. Kendime olan güvenim arttı.”",
   },
   {
      id: 4,
      avatar_thumb: "/assets/img/others/testi_author02.png",
      avatar_name: "Ayşe Demir",
      desc: "“Bu platform öğrenme tarzımı tamamen değiştirdi. Esnek ve pratik yaklaşımı tam aradığım şeydi!”",
   },
];
            ...
            <div className="row justify-content-center">
               <div className="col-xl-5">
                  <div className="section__title text-center mb-50">
                     ...
                     <h2 className="title">What Students Think and Say About 404 Academy</h2>
