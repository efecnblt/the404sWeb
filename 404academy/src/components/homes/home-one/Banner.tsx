...
const Banner = () => {
   ...
   return (
      ...
      >
            ...
            <div className="row justify-content-between align-items-start">
               <div className="col-xl-5 col-lg-6">
                  <div className="banner__content">
                     <h3 className="title tg-svg" data-aos="fade-right" data-aos-delay="400" ref={svgIconRef}>
                        ...
                        <br />
                        Growth starts with <b>learning</b>
                     </h3>
                     <p data-aos="fade-right" data-aos-delay="600">
                        At 404 Academy, we believe every teaching and learning journey is unique. Together, we&apos;ll guide your path to success and discovery.
                     </p>
               ...
               <div className="col-lg-7">
                  <div className="banner__images">
                     <img src="/assets/img/banner/banner_img3.png" alt="img" className="main-img" />
                     ...
                     <div className="banner__author">
                        <div className="banner__author-item">
                           <div className="image">
                              <img src="/assets/img/banner/efe_author.jpg" alt="img"/>
                           </div>
                           <h6 className="name">Efe Canbolat</h6>
                        </div>
                        <div className="banner__author-item">
                           <div className="image">
         ...
         <img src="/assets/img/banner/banner_shape01.svg" alt="shape" className="line-shape" data-aos="fade-right"
              data-aos-delay="1600"/>
      </section>
   );
};
